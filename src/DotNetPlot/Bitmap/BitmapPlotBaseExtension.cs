...
using System;
using DotNetPlot.Bitmap;

namespace DotNetPlot
{
    public static class BitmapPlotBaseExtension
    {
        public static BitmapPlotResult AsBitmap(this Plot plot)
        {
            if (plot is null)
                throw new ArgumentNullException(nameof(plot));

            return new BitmapPlotResult(plot);
        }
    }
}
